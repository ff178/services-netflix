...
class Model {
    ...
    public static function getField($field, $table){
        self::getConnection();
        $sql = "SELECT ".$field." FROM ".$table.";";
        return $results = self::$db->select($sql);
    }
    
    public static function countFromId($field, $table ,$id, $value){
        self::getConnection();
        $sql = "SELECT COUNT(".$field.") FROM ".$table." WHERE ".$id." = '".$value."'";

        return $results = self::$db->select($sql);
    }
    
    public static function count($field, $table){
        self::getConnection();
    ...
    public static function whereF($fields){
        self::getConnection();
        $sql = "SELECT * FROM ".static::$table." WHERE ".$fields;        
        $results = self::$db->select($sql);
    ...
    public function update($id = null, $value = null ){
        ...
        $result = self::$db->update(static::$table,$values,$id." = ".$value);
   ...
   public static function deleteCompuesto($table,$id,$complement){
            self::getConnection();
            
            $result = self::$db->delete($table, $complement." = ".$id);
   ...
   public static function deleteById($id,$complement){
            self::getConnection();
            
            $result = self::$db->delete(static::$table, $complement." = ".$id);
