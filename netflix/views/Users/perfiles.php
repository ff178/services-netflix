  ...
  <body>
      ...
      <div class="perfilesContent">
          ...
          <div class="adminPerfil">
              <a href="<?php print(URL); ?>netflix/Users/administrarPerfil">Administrar perfiles</a>
          </div>
      </div>
  </body>
  <script>
    $.ajax({
      ...
      type: "GET"
        ...
        r.map(function(n){
          $(".content-top1").append(
            '<div class="perfil"><img src="<?php print(URL); ?>netflix/public/assets/fondo2.jpg" alt=""><p>'+n.nombre+'</p></div>');
            console.log(n);
        });
      });
  </script>
